...
XML
    ...
    class TextFormat
      def initialize(bold, italic, underline, gray)
        @bold = bold
        @italic = italic
        @underline = underline
        @gray = gray
      ...
      def to_docx
        ...
        styles << '<w:color w:val="a9a9a9" />' if @gray
      ...
      def with_bold
        TextFormat.new(true, @italic, @underline, false)
      end

      def with_italic
        TextFormat.new(@bold, true, @underline, false)
      end

      def with_underline
        TextFormat.new(@bold, @italic, true, false)
      end
    end
